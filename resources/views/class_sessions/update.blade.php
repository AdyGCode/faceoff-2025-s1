                ...
                <div class="p-4 text-gray-900">
                    <form method="POST" action="{{ route('class_sessions.update', $classSession->id) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input class="mt-1 block w-full" id="title" name="title" type="text" :value="old('title') ?? $classSession->title" required />
                            <x-input-error class="mt-2" :messages="$errors->get('title')" />
                        </div>

                        <div class="mt-4">
                            <x-input-label for="date" :value="__('Date')" />
                            <x-text-input class="mt-1 block w-full" id="date" name="date" type="date" :value="old('date') ?? $classSession->date" required />
